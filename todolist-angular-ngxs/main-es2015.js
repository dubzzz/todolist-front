...
/* harmony import */ var _ngxs_store_internals__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @ngxs/store/internals */ "./node_modules/@ngxs/store/fesm2015/ngxs-store-internals.js");
...
/* harmony import */ var _ngxs_devtools_plugin__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @ngxs/devtools-plugin */ "./node_modules/@ngxs/devtools-plugin/fesm2015/ngxs-devtools-plugin.js");
...
/* harmony import */ var _angular_material_card__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! @angular/material/card */ "./node_modules/@angular/material/esm2015/card.js");
...
/* harmony import */ var _angular_material_badge__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! @angular/material/badge */ "./node_modules/@angular/material/esm2015/badge.js");
...
/* harmony import */ var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! @angular/material/sidenav */ "./node_modules/@angular/material/esm2015/sidenav.js");
...
class AuthGuardService {
    ...
    canActivate(route, state) {
        return this.isAuthenticated$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(isAuth => {
            if (!isAuth) {
...
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ngxs/store */ "./node_modules/@ngxs/store/fesm2015/ngxs-store.js");
...
class AuthenticatedHeaderComponent {
    constructor(store, todolistService) {
        this.store = store;
        this.todolistService = todolistService;
        this.toggleMenu = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.numTodosString$ = this.numTodos$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(n => String(n)));
    }
    ngOnInit() {
...
class TodolistService {
    ...
    registerTodoListener() {
        ...
        this.todoListenerHandle = _api__WEBPACK_IMPORTED_MODULE_2__["addTodoListener"](this.token, todos => {
            this.store.dispatch(new src_state_todolist_todolist_actions__WEBPACK_IMPORTED_MODULE_6__["RefreshTodos"](todos));
        }, () => {
            this.snackBar.open('Revoked token, connection lost', '', {
                duration: 1000
            });
            this.store.dispatch(new src_state_authentication_authentication_actions__WEBPACK_IMPORTED_MODULE_5__["TryLogout"](true));
        });
    }
...
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @ngxs/store */ "./node_modules/@ngxs/store/fesm2015/ngxs-store.js");
...
class LoginComponent {
    ...
    ngOnInit() {
        ...
        this.subscription.add(this.authStatus$.subscribe(s => {
...
let AuthenticationState = class AuthenticationState {
    ...
    tryLoginByCreds({ getState, patchState }, { username, password }) {
    ...
    tryLoginByToken({ getState, patchState }, {}) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                const valid = yield _api__WEBPACK_IMPORTED_MODULE_3__["checkToken"](token);
                if (valid) {
                    patchState({
                        token,
                        username,
    ...
    tryLogout({ getState, patchState }, { silent }) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            patchState({
                token: '',
                username: '',
...
let TodolistState = class TodolistState {
    constructor(snackBar) {
        this.snackBar = snackBar;
    }
    static numTodos(state) {
        return state.todos.length;
    }
    refreshTodos({ getState, patchState }, { todos }) {
        const state = getState();
        const todosBeingAdded = state.todos
            .filter(t => t.state === _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Add)
            .reduce((acc, t) => (Object.assign({}, acc, { [t.data.guid]: t.data })), {});
        const todosBeingEdited = state.todos
            .filter(t => t.state === _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Edit)
            .reduce((acc, t) => (Object.assign({}, acc, { [t.data.guid]: t.data })), {});
        const todosBeingRemoved = state.todos
            .filter(t => t.state === _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Remove)
            .reduce((acc, t) => (Object.assign({}, acc, { [t.data.guid]: t.data })), {});
        const updatedTodos = todos
            ...
            .concat(state.todos.filter(t => t.state === _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Add)); // Add
        patchState({ todos: updatedTodos });
    }
    updateRefreshStatus({ getState, patchState }, { status }) {
        patchState({ ready: status });
    }
    tryAddTodo({ getState, patchState }, { token, task }) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const todo = {
                guid: Math.random()
                    .toString(16)
            ...
            patchState({
                todos: [...getState().todos, { state: _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Add, data: todo }]
            });
            const r = yield _api__WEBPACK_IMPORTED_MODULE_4__["addTodo"](token, todo);
            if (r) {
                patchState({
                    todos: getState().todos.map(t => t.data.guid === todo.guid
    ...
    tryToggleTodo({ getState, patchState }, { token, guid }) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const todo = getState().todos.find(t => t.data.guid === guid && t.state === _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Noop);
            if (!todo) {
            ...
            patchState({
                todos: [
                    ...getState().todos.map(t => t.data.guid === guid
                        ? {
                            state: _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Edit,
                            data: newData
                        }
            ...
            const r = yield _api__WEBPACK_IMPORTED_MODULE_4__["editTodo"](token, newData);
            if (r) {
                patchState({
                    todos: getState().todos.map(t => t.data.guid === guid
                        ? {
    ...
    tryRemoveTodo({ getState, patchState }, { token, guid }) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const todo = getState().todos.find(t => t.data.guid === guid && t.state === _todolist_model__WEBPACK_IMPORTED_MODULE_1__["TodoSyncState"].Noop);
            if (!todo) {
                this.snackBar.open(`No todo available for modification given guid ${guid}`, '', {
            ...
            const r = yield _api__WEBPACK_IMPORTED_MODULE_4__["removeTodo"](token, todo.data);
            if (r) {
